    ...
    return (
        <>
            ...
            <div className="card p-5 rounded bg-success-subtle">
                ...
                <p>Crew : <strong>{result.crew}</strong></p>
                <p>Hyperdrive-rating : <strong>{result.hyperdrive_rating}</strong></p>
                <p>Manufacturer : <strong>{result.manufacturer}</strong></p>
                <p>Class : <strong>{result.starship_class}</strong></p>
            </div>
            <div>
